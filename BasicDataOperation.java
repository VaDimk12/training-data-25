 ...
 * <pre>
 * {@code
 * java BasicDataOperation "03:49:17" list
 * java BasicDataOperation "03:49:17" queue  
 * java BasicDataOperation "03:49:17" set
 * java BasicDataOperation "03:49:17" all
 * }
 * </pre>
 */
public class BasicDataOperation {
    ...
    private static final String USAGE_MESSAGE = "Використання: java BasicDataOperation <пошукове-значення у форматі HH:mm:ss> \n" +
"Приклад:\n" +
"  java BasicDataOperation \"03:49:17\"";
    ...
    public static void main(String[] args) {
        ...
        // Валідація введеного значення часу
        try {
            LocalTime.parse(searchValue, DateTimeFormatter.ISO_LOCAL_TIME);
        } catch (Exception e) {
            System.out.println("Помилка: Невірний формат часу. Використовуйте HH:mm:ss (наприклад: 03:49:17)");
            return;
        }
    ...
    private void executeOperations(String[] args) {
        ...
        localTimeValueToSearch = LocalTime.parse(args[0], DateTimeFormatter.ISO_LOCAL_TIME);
