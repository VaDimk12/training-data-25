...
public class BasicDataOperationUsingQueue {
    ...
    * Метод завантажує дані, виконує операції з чергою та масивом LocalTime.
    ...
    public void runDataProcessing() {
        // спочатку обробляємо чергу часу
        findInQueue();
        locateMinMaxInQueue();
    ...
    * Сортує масив об'єктiв LocalTime та виводить початковий i вiдсортований масиви.
    ...
    private void performArraySorting() {
        // вимірюємо тривалість упорядкування масиву типу LocalTime
        long timeStart = System.nanoTime();

        Arrays.sort(localTimeArray);

        PerformanceTracker.displayOperationTime(timeStart, "упорядкування масиву типу LocalTime");
    }
